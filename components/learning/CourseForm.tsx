...
import { addCourse } from "@/app/actions/learning";
...
export function CourseForm() {
  ...
  return (
    ...
    >
      ...
      <Input name="name" placeholder="e.g. AI / Machine Learning" required />
      <Textarea name="description" placeholder="What are you working on? (optional)" rows={2} />
